  ...
  function srcAppGameServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var GameService = /*#__PURE__*/function () {
      function GameService(http) {
        ...
        this.http = http;
        this.getUrlStatus = 'http://37.57.31.220:3000/api/rooms/3/status';
        this.getUrlStartGame = 'http://37.57.31.220:3000/api/rooms/3';
        this.getUrlCategories = 'http://37.57.31.220:3000/api/rooms/3/questions/categories/category_1';
        this.getUrlEndGame = 'http://37.57.31.220:3000/api/rooms/3/end';
      }
